...
## x.x.x [WIP]
- Added automated Minecraft 1.21.11 startup, overlay rendering, metric visibility, configuration-screen and persistence, and guarded F7-F10 key and benchmark-race tests.
