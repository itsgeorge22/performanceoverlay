...
## x.x.x [WIP]
- Added automated Minecraft 1.21.11 startup, overlay rendering, configuration-screen, configuration-copying, and guarded F7-F10 key and benchmark-race tests.
