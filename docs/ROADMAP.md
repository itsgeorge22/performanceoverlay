...
- [ ] Create a separate Java 25, unobfuscated build line targeting Minecraft 26.1.2.
- [ ] Test the 26.1.2 JAR on Minecraft 26.1, 26.1.1, and 26.1.2; declare one 26.1-26.1.2 range only if every version passes.
